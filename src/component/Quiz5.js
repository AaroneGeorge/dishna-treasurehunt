...
const Quiz5 = () => {
  const question = { question: "What type of extinguisher is no longer suitable for use", answer: "Halon" };
  const nextLocation = "Guardian of the chamber where judgements preside";
  ...
  return (
    <div className="quiz-container">
      <div>
        <h3 className="question-heading">Question 5</h3>
